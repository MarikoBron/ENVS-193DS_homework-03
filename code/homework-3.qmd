...
colnames(screentime_clean)
head(screentime_clean[["tasks due"]])


screentime_cleaner <- screentime_clean[,c("tasks due", "stress value", "screentime(h)")]


flextable(
  screentime_cleaner,
  col_keys = c("tasks due", "stress value", "screentime(h)"),
  cwidth = 2,
  cheight = 0.25,
  defaults = list(),
