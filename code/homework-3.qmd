...
screentime_clean <- screentime |>  #create object screentime_clean
  ...
  arrange(`screentime(h)`) #arrange by increasing screentime/dependant var to loo for patterns
...
ggplot(screentime_clean, 
  ...
  labs(
    title = "Relationship Between Screentime, Perceived Stress Value,\nand Number of Tasks Due",
    x = "Stress Value",
    y = "Screentime (h)",
    color = "Tasks Due" #add labels, color by tasks due
  ) +
  
  scale_color_discrete_sequential(palette = "SunsetDark") #choose color palette
```
...
set_flextable_defaults(
  ...
  font.color = "#a059a0" #making table match my plot
  )
...
screentime_cleaner_table #view my object
